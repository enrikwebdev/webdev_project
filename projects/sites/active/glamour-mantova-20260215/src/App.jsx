...
function Logo() {
  return (
    <div className="flex items-center gap-3">
      <div className="flex h-9 w-9 items-center justify-center rounded-full border border-amber-200/60 bg-black/30 text-xs font-black tracking-[0.12em] text-amber-100">
        G
      </div>
      <div>
        <div className="text-xs uppercase tracking-[0.28em] text-amber-100">Glamour</div>
...
function Pill({ children }) {
  return <span className="rounded-full border border-amber-200/35 bg-black/20 px-3 py-1 text-xs text-amber-100">{children}</span>
}
...
function ReviewsBlock() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      <div data-reveal>
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-amber-100">Fiducia</p>
    ...
    <>
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto grid min-h-[78vh] max-w-7xl items-center gap-10 px-6 py-16 md:grid-cols-2">
          <div data-reveal>
            <p className="mb-4 text-xs font-semibold uppercase tracking-[0.24em] text-amber-100">Glamour · Mantova</p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="tel:+393313769201" className="inline-block rounded-full bg-amber-200 px-6 py-3 text-sm font-bold text-black">
                Prenota ora
              </a>
              <a
                href="/trattamenti"
                ...
                className="inline-block rounded-full border border-amber-200/60 px-6 py-3 text-sm font-bold text-amber-100 hover:bg-amber-200 hover:text-black"
              >
                Vedi servizi
              </a>
            </div>
      ...
      <section className="mx-auto max-w-7xl space-y-6 px-6 py-20">
        <div data-reveal className="mb-2">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-amber-100">Storytelling visivo</p>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div data-reveal className="grid overflow-hidden rounded-[2rem] border border-amber-200/25 bg-gradient-to-r from-[#151113] to-[#1c1411] md:grid-cols-2">
          <img
          ...
          <div className="p-10 md:p-14">
            <p className="text-xs uppercase tracking-[0.22em] text-amber-100">CTA unica</p>
            ...
            <a
              ...
              className="mt-8 inline-block w-full rounded-full bg-amber-200 px-6 py-4 text-center text-base font-bold text-black sm:w-auto sm:px-8"
            >
              Chiama 331 376 9201
            </a>
          </div>
...
function TrattamentiPage() {
  const services = [
    ['Taglio Donna / Uomo', 'Taglio su misura in base a viso, volume e stile.', 'https://images.unsplash.com/photo-1580618672591-eb180b1a973f?auto=format&fit=crop&w=1200&q=80'],
    ...
    ['Degradé & Sfumature', 'Transizioni morbide e pulite, zero stacchi netti.', 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?auto=format&fit=crop&w=1200&q=80'],
    ['Trattamenti Cheratina', 'Ricostruzione e disciplina per capelli più sani e forti.', 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=1200&q=80'],
    ['Unghie (cheratina) & manicure', 'Servizi beauty per un look completo, curato nei dettagli.', 'https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=1200&q=80'],
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div data-reveal>
        <p className="text-xs uppercase tracking-[0.22em] text-amber-100">Servizi</p>
        ...
        {services.map(([t, d, img]) => (
          <article key={t} data-reveal className="overflow-hidden rounded-3xl border border-white/10 bg-[#141012]">
            ...
            <div className="p-7">
              ...
              <a href="tel:+393313769201" className="mt-5 inline-block text-sm font-semibold text-amber-100 underline underline-offset-4">
    ...
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div data-reveal className="rounded-3xl border border-white/10 bg-[#141012] p-8 md:p-10">
          <p className="text-xs uppercase tracking-[0.22em] text-amber-100">Dove siamo</p>
          ...
          <a href="tel:+393313769201" className="mt-7 inline-block rounded-full bg-amber-200 px-6 py-3 text-sm font-bold text-black">
            Chiama ora
          </a>
        </div>
      </div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div className="grid gap-6 md:grid-cols-2">
        <figure data-reveal className="overflow-hidden rounded-3xl border border-white/10">
          <img
            src="https://images.unsplash.com/photo-1519699047748-de8e457a634e?auto=format&fit=crop&w=1400&q=80"
            alt="Salone parrucchiere"
            className="h-full w-full object-cover"
          />
        </figure>
        <div data-reveal className="rounded-3xl border border-white/10 bg-[#141012] p-8 md:p-10">
          <p className="text-xs uppercase tracking-[0.22em] text-amber-100">Chi siamo</p>
...
function BlogPage() {
  const posts = [
    ['Taglio giusto in base alla forma del viso', 'Come valorizzare i lineamenti con scelte semplici e concrete.', 'https://images.unsplash.com/photo-1583001931096-959e9a1a6223?auto=format&fit=crop&w=1200&q=80'],
    ['Come mantenere il colore luminoso più a lungo', 'Routine rapida tra un appuntamento e l’altro (senza prodotti inutili).', 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=1200&q=80'],
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div data-reveal>
        <p className="text-xs uppercase tracking-[0.22em] text-amber-100">Blog</p>
    ...
    <section className="mx-auto max-w-6xl px-6 py-16">
      <div data-reveal className="grid overflow-hidden rounded-[2rem] border border-amber-200/25 bg-gradient-to-r from-[#151113] to-[#1c1411] md:grid-cols-2">
        ...
        <div className="p-10 md:p-14">
          ...
          <a href="tel:+393313769201" className="mt-8 inline-block w-full rounded-full bg-amber-200 px-6 py-4 text-center text-base font-bold text-black sm:w-auto sm:px-8">
            Chiama 331 376 9201
          </a>
...
export default function App() {
  ...
  const Link = ({ to, children }) => (
    <button
      onClick={() => go(to)}
      className={`whitespace-nowrap rounded-full px-3 py-1.5 ${route === to ? 'bg-amber-200 text-black' : 'hover:text-amber-100'}`}
    >
      {children}
    </button>
  )
    ...
    <main className="min-h-screen bg-[#0e0b0d] text-[#f5eee9]">
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#0e0b0d]/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6 md:py-4">
          ...
          <a
            href="tel:+393313769201"
            className="rounded-full border border-amber-200/60 px-4 py-2 text-xs font-semibold text-amber-100 hover:bg-amber-200 hover:text-black"
          >
            Chiama
          </a>
        </div>
      ...
      <div className="border-b border-white/10 bg-[#131014] px-4 py-2 text-xs text-[#d8c8c0] md:px-6">
        <div className="mx-auto flex max-w-7xl items-center gap-2">
          <button onClick={() => go('/')} className="underline-offset-2 hover:text-amber-100 hover:underline">
            Home
          </button>
          <span>/</span>
          <span className="font-semibold text-amber-100">{sectionLabel}</span>
        </div>
      </div>
